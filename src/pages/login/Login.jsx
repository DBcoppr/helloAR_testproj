...
function Login() {
  ...
  return <div className="w-full h-screen flex items-center justify-center">
    <div className="w-[407px] h-[238px]">
      ...
      <p className="  font-normal text-xs mb-3">Please enter your mobile number to login. We will send an OTP to verify your number.</p>
      <InputTel className="mb-6 w-full" onChange={inputTel} value={phone}/>
      <button className="bg-purple rounded-xl text-lg text-center font-bold text-white py-3.5 w-full" onClick={handleClick}>Sign In</button>
    </div>
  </div>;
}
